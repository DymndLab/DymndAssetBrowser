...
public static class BuildModeService
{
    ...
    public static bool IsDoorFrame(AssetRecord asset) => asset.Family.Equals("Door Frames", StringComparison.OrdinalIgnoreCase)
        || asset.FileName.Contains("Door_Frame", StringComparison.OrdinalIgnoreCase);
    public static bool IsWindowSill(AssetRecord asset) => asset.Family.Equals("Window Sills", StringComparison.OrdinalIgnoreCase)
