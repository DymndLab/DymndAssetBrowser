...
{
    public SourcePlannerRecipe? SourcePlanner { get; init; }
...
public sealed record PlannerSourceSelection
{
    public bool MaterialsFollowWalls { get; init; }
    public SourceBrowserFilter Filter { get; init; } = new();
    public string SelectedIdentity { get; init; } = "";
}

public sealed record SourcePlannerRecipe
{
    public PlannerSourceSelection Walls { get; init; } = new();
    public PlannerSourceSelection Floor { get; init; } = new();
    public PlannerSourceSelection Trim { get; init; } = new();
}
