...
public sealed record ApplicationState
{
    ...
    public SourceBrowserFilter BrowserFilter { get; init; } = new();
    public Dictionary<string, UserAssetTags> UserTags { get; init; } = new(StringComparer.OrdinalIgnoreCase);
    public double ThumbnailSize { get; init; } = 220;
}
